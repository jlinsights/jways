        ...
        <div className="absolute inset-0 p-8 md:p-12">
                ...
                >
                    ...
                    <AnimatePresence>
                        {activeTooltip === 'origin' && (
                            ...
                            >
                                <div className="text-[10px] text-blue-500 uppercase tracking-wider mb-0.5">Origin</div>
                                <div className="text-sm">{shipment.origin.city}</div>
                    ...
                    <AnimatePresence>
                        {activeTooltip === 'destination' && (
                            ...
                            >
                                ...
                                <div className="text-sm">{shipment.destination.city}</div>
                                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 border-4 border-transparent border-t-white" />
                            </motion.div>
                        )}
                    </AnimatePresence>
                ...
                >
                    <div className="relative -translate-x-1/2 -translate-y-1/2">
                        ...
                        {/* Tooltip */}
                        <AnimatePresence>
                            {(activeTooltip === 'current' || activeTooltip === null) && ( // Show initially or on hover
                                <motion.div 
                                    initial={{ y: 10, opacity: 0, scale: 0.8 }}
                                    animate={{ 
                                        y: 0, 
                                        opacity: activeTooltip === 'current' ? 1 : 0, // Only visible on hover/click interaction now
                                        scale: activeTooltip === 'current' ? 1 : 0.8 
                                    }}
